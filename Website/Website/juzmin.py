...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "BipolarBuddy Admin",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "BipolarBuddy Administration",
    ...
    "welcome_sign": "Welcome to BipolarBuddy  Admin",

    # Copyright on the footer
    "copyright": f"BipolarBuddy ",

    # The model admin to search from the search bar, search bar omitted if excluded
    "search_model": "authmanagement.MyUser",

    # Field name on user model that contains avatar ImageField/URLField/Charfield or a callable that receives the user
    "user_avatar": "/assets/logo/logo.png",
    ...
    "topmenu_links": [
        ...
        {"name": "Support", "url": "https://BipolarBuddy.co.ke", "new_window": True},
    ],
    ...
    "changeform_format_overrides": {"accounts.CustomUser": "vertical_tabs", "auth.group": "vertical_tabs"},
